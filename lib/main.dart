...
var myColorSchema = ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 59, 96, 179)); 
// Example of a color schema
var myDarkColorSchema = ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 59, 96, 179)); // Example of a color schema
